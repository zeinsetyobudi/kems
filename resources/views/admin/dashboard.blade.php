                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/id.png"
                                                                alt="indonesia">
                                                        </div>
                                                    </td>
                                                    <td>Indonesia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/us.png"
                                                                alt="united states">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/au.png"
                                                                alt="australia">
                                                        </div>
                                                    </td>
                                                    <td>Australia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/ru.png"
                                                                alt="russia">
                                                        </div>
                                                    </td>
                                                    <td>Russia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/cn.png"
                                                                alt="china">
                                                        </div>
                                                    </td>
                                                    <td>China</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('/vendor/azzara') }}/img/flags/br.png"
                                                                alt="brazil">
                                                        </div>
                                                    </td>
                                                    <td>Brasil</td>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ url('/vendor/azzara') }}/img/logoproduct.svg" alt="..."
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ url('/vendor/azzara') }}/img/logoproduct2.svg" alt="..."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ url('/vendor/azzara') }}/img/logoproduct3.svg" alt="..."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-list">
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('/vendor/azzara') }}/img/jm_denis.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('/vendor/azzara') }}/img/chadengle.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('/vendor/azzara') }}/img/talha.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('/vendor/azzara') }}/img/mlane.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
