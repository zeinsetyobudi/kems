        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('company_data.index') }}">Order Key</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <form action="{{ route('company_data.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="name_company" class="font-weight-bold">Company Data</label>
                                    <input type="text" class="form-control @error('name_company') is-invalid @enderror"
                                        name="name_company" value="{{ $company_data->name_company }}" placeholder="Edit name company">
                                    @error('name_company')
